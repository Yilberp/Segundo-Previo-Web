<%-- 
    Document   : listavehiculosxpersona
    Created on : 26/05/2020, 08:42:57 PM
    Author     : Mindchift
--%>
    ...
    <body>
		...
		<article class="lista__content">
			...
			<form class="form-group">
				<label>Cedula</label>
				<input type="number" style="margin-bottom: 1em" placeholder="Numero de documento" name="Texto" id="Texto" class="form-control">
