...
if(session.getAttribute("usuario")==null){
    ...
    return;    
      ...
      out.write("                    <form action=\"mensajevehiculo.jsp\" method=\"get\">\n");
      out.write("                        <div class=\"login__form__content\">\n");
      out.write("                            <h2 class=\"login__form__content--h2\">Registrar vehiculo</h2>\n");
      out.write("                            <div class=\"login__form__container-cmp\">\n");
      out.write("                                <input class=\"login__form__content--cmp\" type=\"text\" id=\"placa\" name=\"placa\" placeholder=\"Placa\" required>\n");
      out.write("                            </div>\n");
      out.write("                            <div class=\"login__form__container-cmp\">\n");
      out.write("                                <select class=\"combobox\" name=\"modelo\" id=\"modelo\">\n");
      out.write("                                ");

                                    Vehiculo v = new Vehiculo();
                                    ResultSet rs = v.buscarModelo();
                                    while (rs.next()) {
                                        out.print("<option value='" + rs.getString("MODELO") + "'>"
                                                + rs.getString("MODELO") +"</option>");
                                    }
      ...
      out.write("                            </div>\n");
      out.write("                            <div class=\"login__form__container-cmp\">\n");
      out.write("                                <input class=\"login__form__content--cmp\" type=\"text\" id=\"marca\" name=\"marca\" placeholder=\"Marca\" required>\n");
      out.write("                            </div>\n");
      out.write("\n");
      out.write("                            <div class=\"login__form__container-cmp\">\n");
      out.write("                                <input class=\"login__form__content--cmp\" type=\"text\" id=\"serial\" name=\"serial\" placeholder=\"Serial Carroceria\" required>\n");
      out.write("                            </div>\n");
      out.write("                            <div class=\"login__form__container-cmp\">\n");
      out.write("                                <input class=\"login__form__content--cmp\" type=\"number\" id=\"valor\" name=\"valor\" placeholder=\"Valor Comercial\" required>\n");
      out.write("                            </div>\n");
      out.write("                            <select class=\"combobox\" name=\"propietario\" id=\"propietario\">\n");
      out.write("                                ");
      ...
      out.write("                   \n");
      out.write("                            </select>                    \n");
      out.write("                            <input class=\"login__form__content--btn\" type=\"submit\" name=\"regvehiculo\" id=\"regvehiculo\" value=\"Registrar\">\n");
      out.write("                        </div>\n");
      out.write("                    </form>\n");
      out.write("                </div>\n");
      out.write("                <figure class=\"login__fig\">\n");
      out.write("                    <img class=\"login__img\" src=\"imagen/vehiculo.jpeg\">\n");
      out.write("                </figure>\n");
      out.write("            </article>\n");
      out.write("        </section>\n");
      out.write("\n");
