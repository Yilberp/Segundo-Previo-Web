<%-- 
    Document   : regsoat
    Created on : 24/05/2020, 06:57:05 PM
    Author     : Mindchift
--%>
        ...
        <section class="login">
            <article class="login__content">
                <div class="login__form">
                    <form action="mensajeregsoat.jsp" method="get">
                        <div class="login__form__content">
                            <h2 class="login__form__content--h2">Registrar vehiculo</h2>
                            <p class="p-select">Cédula</p>

                            <select class="combobox" name="persona" id="persona" onchange="Mifuncion(this.value)">
                                <%
                                ...
                                %>
                                <script>
                                    let primeracarga = document.getElementById("persona").value;
                            ...
                            <input class="login__form__content--btn" type="submit" name="regsoat" id="regsoat" value="Registrar">
                        </div>
                    </form>
                </div>
